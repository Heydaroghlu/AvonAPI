        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    otherAddress = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true),
                    ...
                    IsFirst = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    Gain = table.Column<double>(type: "double", nullable: true),
                    FirstAmount = table.Column<double>(type: "double", nullable: true),
                    TotalAmount = table.Column<double>(type: "double", nullable: true),
                    ReferalIdforTeam = table.Column<string>(type: "longtext", nullable: true),
                    IdForReferal = table.Column<string>(type: "longtext", nullable: true),
                    OrderCountForMounth = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(type: "longtext", nullable: false),
                    FIrstAmount = table.Column<int>(type: "int", nullable: false),
                    UserCount = table.Column<int>(type: "int", nullable: false),
                    Percent = table.Column<int>(type: "int", nullable: false),
                    SecondPercent = table.Column<int>(type: "int", nullable: false),
                    ThirdPercent = table.Column<int>(type: "int", nullable: false),
                    MustSale = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReferalTables", x => x.Id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Teg", x => x.Id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VFeatures", x => x.Id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreOrder = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetAddres = table.Column<string>(type: "longtext", nullable: false),
                    ...
                    CodePrefix = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    VFeatureId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VariantFeature", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VariantFeature_Variants_VariantId",
                        column: x => x.VariantId,
                        principalTable: "Variants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VariantFeature_VFeatures_VFeatureId",
                        column: x => x.VFeatureId,
                        principalTable: "VFeatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Image = table.Column<string>(type: "longtext", nullable: false),
                    IsPoster = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTeg", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductTeg_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTeg_Teg_TegId",
                        column: x => x.TegId,
                        principalTable: "Teg",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsTeg", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsTeg_News_NewsId",
                        column: x => x.NewsId,
                        principalTable: "News",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NewsTeg_Teg_TegId",
                        column: x => x.TegId,
                        principalTable: "Teg",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsTeg_NewsId",
                table: "NewsTeg",
                column: "NewsId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsTeg_TegId",
                table: "NewsTeg",
                column: "TegId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTeg_ProductId",
                table: "ProductTeg",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductTeg_TegId",
                table: "ProductTeg",
                column: "TegId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantFeature_VariantId",
                table: "VariantFeature",
                column: "VariantId");

            migrationBuilder.CreateIndex(
                name: "IX_VariantFeature_VFeatureId",
                table: "VariantFeature",
                column: "VFeatureId");
